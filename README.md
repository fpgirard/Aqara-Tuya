...
Rigorous tests for both using a Home Assistant script that opens and closes these valves at random intervals between 1 and 3 minutes would be logical next step.  Let's see which one dies first.  Perhaps I should add the Bulldog to the mix?
...
[<code>stl</code>](https://github.com/fpgirard/xpedition/tree/main/stl) contains various .stl files for different valve bodies for both the Aqara and Tuya controllers   
[<code>src</code>](https://github.com/fpgirard/xpedition/tree/main/docs) has installation instructions and other supporting documents (images).
